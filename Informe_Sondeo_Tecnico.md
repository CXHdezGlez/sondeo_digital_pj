...
Ajustes muestrales:
Ponderador por estado (peso\_estado)
Ponderador por edad y sexo (ajuste\_edad\_sexo)
Ponderador combinado final (peso\_raking)
...
El análisis jerárquico de conglomerados se ha realizado con el método de Ward, el cual minimiza la varianza dentro de los grupos al formar conglomerados. El procedimiento se aplicó a los casos ponderados por el factor de expansión (peso\_raking), lo que asegura que la segmentación refleje la estructura poblacional del sondeo.
